...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.employee.create',['user'=>$user,'title'=>'create employees','companies'=>  $companies]);
    ...
    public function edit($id)
    {
        ...
        $employee=$this->employee->show($id);
            return view('admin.employee.edit',['user'=>$user,'title'=>'Edit Employees','employee'=>$employee,'companies'=>$companies]);
